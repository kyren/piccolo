...
do
    ...
    assert(string.rep("abc", 2) == "abcabc")
    assert(string.rep("a", 3, ",") == "a,a,a")
    assert(string.rep("abc", 2, "-") == "abc-abc")
    assert(string.rep("x", 0) == "")
    assert(string.rep("x", 1) == "x")
    assert(string.rep("x", -1) == "")
    assert(string.rep("x", -5) == "")
    assert(string.rep("", 10) == "")
    assert(string.rep("", 0) == "")
    assert(string.rep("abc", 1, "-") == "abc")
    assert(string.rep("a", 3, "") == "aaa")
    assert(string.rep("a", 4, ", ") == "a, a, a, a")
    assert(string.rep("\0", 3) == "\0\0\0")
    assert(string.rep("a\0b", 2, "x") == "a\0bx" .. "a\0b")
    assert(string.rep(123, 2) == "123123")
    assert(string.rep("a", 3, 12) == "a12a12a")
    assert(string.rep("a", "2") == "aa")
    assert(is_err(function() return string.rep(nil, 2) end))
    assert(is_err(function() return string.rep({}, 2) end))
    assert(is_err(function() return string.rep("a", {}) end))
    assert(is_err(function() return string.rep("a", 1.5) end))
