...
| 🟡     | `randomseed([x, y])` | `math.randomseed()` does not attempt to randomly generate a seed, and looking at the code, the second argument is ignored, leading to only be able to seed using 64-bits.[^6] |       |
| 🔵     | `sin(x)`             |                                                                                                                                                                               |       |
| 🔵     | `sqrt(x)`            |                                                                                                                                                                               |       |
| 🔵     | `tan(x)`             |                                                                                                                                                                               |       |
| 🔵     | `tointeger(x)`       |                                                                                                                                                                               |       |
